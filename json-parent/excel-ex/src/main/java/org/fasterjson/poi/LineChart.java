...
public class LineChart {
	...
	public static void lineChart() throws FileNotFoundException, IOException {
		try (XSSFWorkbook wb = new XSSFWorkbook()) {
    	    ...
    	    int pointCount = series2.getCategoryData().getPointCount();
    	    //for(int i = 0)
    	    
    	    XDDFDataPoint p = series2.getDataPoint(1);
    	    p.setMarkerSize((short)10);
    	    p.setMarkerStyle(MarkerStyle.DIAMOND);
    	    //p.setShapeProperties(null);
